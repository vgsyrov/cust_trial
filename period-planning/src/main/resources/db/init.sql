...
CREATE
UNIQUE INDEX Lession_UNQ_lessionId ON Lession (lessionId);
...
CREATE
UNIQUE INDEX LessionParticipant_UNQ_lessionId_personId ON LessionParticipant (lessionId, personId);
...
insert into LessionParticipant(lessionId, personId)
values ('initialLesson_6', 'initialPersonData_1');
insert into LessionParticipant(lessionId, personId)
values ('initialLesson_6', 'initialPersonData_2');
insert into LessionParticipant(lessionId, personId)
values ('initialLesson_6', 'initialPersonData_3');